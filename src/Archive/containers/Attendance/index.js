      ...
      if(matchedId.length == 0){
        Alert.alert(
          ...
          [
            ...
            {text: 'Yes', onPress: () => this.sendEmployeeAttendance(dataPass)},
          ],
          { cancelable: false }
        )
      }
      else{
        this.sendEmployeeAttendance(dataPass);
      }
      
  }
  sendEmployeeAttendance(dataReceived){
    ...
    const dataValue = {"Id":"0","UserId":this.props.userCredential.data.ID.toString(),"StatusDate":moment().format('MM/DD/YY HH:mm'),"StatusType": dataReceived.Value,"AttendanceId":"0","Comments":"check","Created_By":"0","Created_Date":"null","Is_Active":"false"}
